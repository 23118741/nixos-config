...

{
  ...
  # Manage i3 config and related dotfiles
  xsession.windowManager.i3 = {
    ...
    config = {
      ...
      keybindings = pkgs.lib.mkOptionDefault {
        "${config.xsession.windowManager.i3.config.modifier}+s" = "exec rofi -show drun";
      };
    };
  };
  ...
  # or
  #
  #  /etc/profiles/per-user/guus/etc/profile.d/hm-session-vars.sh
  #
